...
namespace AppUI
{
    public class AppService
    {
        ...
        private AppService()
        {
            ...
            this.AddToEventLoginOccured(onLoginCallback);
        }
        ...
        public void RemoveFromEventLoginOccured(Action i_Callback)
        {
            m_ServiceLogin.LoginOccured -= i_Callback;
        }

        public void RemoveFromEventUserNameChanged(Action<string> i_Callback)
        {
            DataService.UserNameChanged -= i_Callback;
        }

        public void RemoveFromEventProfilePictureURLChanged(Action<string> i_Callback)
        {
            DataService.ProfilePictureURLChanged -= i_Callback;
        }

        public void RemoveFromEventPostDataChanged(Action<FacebookObjectCollection<Post>> i_Callback)
        {
            DataService.PostDataChanged -= i_Callback;
        }

        public void RemoveFromEventFriendsDataChanged(Action<FacebookObjectCollection<User>> i_Callback)
        {
            DataService.FriendsDataChanged -= i_Callback;
        }

        public void RemoveFromEventPagesDataChanged(Action<FacebookObjectCollection<Page>> i_Callback)
        {
            DataService.PagesDataChanged -= i_Callback;
        }
